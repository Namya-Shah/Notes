...
- view or configure network routing tables
...
- control system services and settings
...
- switches user to become another user
...
- execute a command as another user or with elevated privileges
...
- display disk usage by file or directory
...
- locate a program or command in the system path
...
- displays all the information about user
...
- display text or variables to the console
...
- sort lines of text in a file or input
...
- remove duplicate lines from a file or input
...
- display the first/last few lines of a file or input

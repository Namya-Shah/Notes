```markdown
## Summary
In summary, [Insert High-Signal Summary Here - 1-2 Sentences]
```

## Headlines

[Bulleted List of Key Insights – Each bullet starts with a bold declarative statement ending with a period.  Include one short supporting sentence after each headline.]

## Things

*   **People:** [List of People Explicitly or Strongly Implied]
*   **Organizations:** [List of Organizations Explicitly or Strongly Implied]
*   **Places:** [List of Places Explicitly or Strongly Implied]
*   **Numbers & Statistics:** [List of Numbers & Statistics Explicitly or Strongly Implied]
*   **Products & Technologies:** [List of Products & Technologies Explicitly or Strongly Implied]
*   **Concepts & Themes:** [List of Concepts & Themes Explicitly or Strongly Implied]
...
To understand these changes in more detail, we conducted an analysis of 500,000 coding-related interactions across [Claude.ai](http://claude.ai/redirect/website.v1.5eea3f5c-c749-48d9-93b6-af41846ce9dc) (the “default” way that most people interact with Claude) and [Claude Code](https://docs.anthropic.com/en/docs/agents-and-tools/claude-code/overview) (our new specialist coding “agent” that can independently accomplish chains of complex tasks using a variety of digital tools).
